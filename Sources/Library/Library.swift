...
public struct Media: Codable {
    ...
    public static func fixture(_ title: String = "Media Title", _ image: String = "", _ description: String = LoremIpsum.text, _ links: [String: String] = ["Amazon": "https://www.amazon.com/link", "Apple": "https://apple.com/music"]) -> Media {
